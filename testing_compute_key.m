...
figure;
plot(distances(1,:),'b','LineWidth',2)
hold on
plot(distances(2,:),'r','LineWidth',2)
title('Manhattan Distances vs Tonic Centers')
axis([1 12 1 inf])
ylim([0 1])
xticklabels({'C','C#','D','D#','E','F','F#','G','G#','A','A#','B',})
xlabel('Tonic Centers')
ylabel('Manhattan Distance')
legend('Ionian Mode', 'Aeolian Mode')
